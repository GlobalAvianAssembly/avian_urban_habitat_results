...
birdlife_ssm = ggplot(birdlife_city_data_named, aes(x = region_50km_ssm, y = response)) + 
  ...
  theme_bw() +
  ylab("City Random Effect Intercept") + xlab("Regional (50km) SSM") + labs(title = "a)")
...
birdlife_ldg = ggplot(birdlife_data_with_lat, aes(x = city_centre_latitude, y = response)) + 
  ...
  theme_bw() +
  ylab("City Random Effect Intercept") + xlab("Latitude (of city centre)") + labs(title = "Birdlife LDG")
...
birdlife_plot_ldg = ggplot(birdlife_data_with_lat, aes(x = city_centre_latitude, y = response)) + 
  ...
  theme_bw() +
  ylab("City Random Effect Intercept") + xlab("Latitude (of city centre)") + 
...
birdlife_ssm2 = ggplot(birdlife_city_data_named, aes(x = region_50km_ssm, y = response)) + 
  ...
  guides(colour=guide_legend(title="SSM in 50km Surrounding city")) +
  theme_bw() +
  ylab("City Random Effect Intercept") + xlab("Regional (50km) SSM") +
  theme(legend.position="bottom", legend.box = "horizontal")
...
annotate_figure(birdlife_figure,
                left = text_grob("City random effect intercept", rot = 90))
