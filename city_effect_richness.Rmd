...
```{r}
results <- boot(data=merlin_city_data, statistic=rsq, R=1000, formula=response ~ I(merlin_pool_size^2))
results
```
...
```{r}
results <- boot(data=merlin_city_data, statistic=rsq, R=1000, formula=response ~ biome_name + I(merlin_pool_size^2))
results
```
...
```{r}
results <- boot(data=merlin_city_data, statistic=rsq, R=1000, formula=response ~ biome_name + rainfall_monthly_min + I(merlin_pool_size^2))
results
```
...
-- Birdlife
```{r}
results <- boot(data=birdlife_city_data, statistic=rsq, R=1000, formula=response ~ birdlife_pool_size)
results
```

```{r}
results <- boot(data=birdlife_city_data, statistic=rsq, R=1000, formula=response ~ I(birdlife_pool_size^2))
results
```

```{r}
results <- boot(data=birdlife_city_data, statistic=rsq, R=1000, formula=response ~ biome_name + birdlife_pool_size)
results
```

```{r}
results <- boot(data=birdlife_city_data, statistic=rsq, R=1000, formula=response ~ biome_name + I(birdlife_pool_size^2))
results
```

```{r}
results <- boot(data=birdlife_city_data, statistic=rsq, R=1000, formula=response ~ biome_name + rainfall_monthly_min * birdlife_pool_size)
results
```

```{r}
results <- boot(data=birdlife_city_data, statistic=rsq, R=1000, formula=response ~ biome_name + rainfall_monthly_min + I(birdlife_pool_size^2))
results
```
