...
```{r}
write_csv(both_niche_city_response[, c('name', 'response')], 'both_city_niche_resilience_intercept.csv')
```
...
```{r}
write_csv(either_niche_city_response[, c('name', 'response')], 'either_city_niche_resilience_intercept.csv')
```
