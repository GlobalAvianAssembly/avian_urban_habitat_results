...
```{r}
merlin_nicheres_plot <- merlin_niche_resiliance_sum[bl_niche_resiliance_sum$model == 'full',]
...
merlin_nicheres_plot$type[merlin_nicheres_plot$explanatory %in% c('mean_elevation_scaled', 'elevation_delta_scaled')] <- 'Average elevation\n5 km around site'
...
ggplot(merlin_nicheres_plot, aes(y=explanatory, x=niche_resiliance_merlin_estimate, colour = type)) + 
  ...
  guides(colour=guide_legend(title="Explanatory type")) + xlab('Increase in\n(percentage of regional niches / percentage of regional richness)\n± Standard Error') + ylab('Explanatory')
...
birdlife_nicheres_plot$type[birdlife_nicheres_plot$explanatory %in% c('mean_elevation_scaled', 'elevation_delta_scaled')] <- 'Average elevation\n5 km around site'
...
ggplot(birdlife_nicheres_plot, aes(y=explanatory, x=niche_resiliance_birdlife_estimate, colour = type)) + 
  geom_line() +
  geom_point()+
