...
```{r}
write_csv(merlin_niche_city_response[, c('name', 'response')], 'niche_resilience__output__merlin_city_niche_resilience_intercept.csv')
```
...
merlin_nicheres_plot$type[merlin_nicheres_plot$explanatory %in% c('mean_elevation_scaled', 'elevation_delta_scaled')] <- 'Scaled (0-1) average\nelevation 5 km around site'
...
birdlife_nicheres_plot$type[birdlife_nicheres_plot$explanatory %in% c('mean_elevation_scaled', 'elevation_delta_scaled')] <- 'Scaled (0-1) average\nelevation 5 km around site'
