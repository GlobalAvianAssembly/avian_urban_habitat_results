...
birdlife300_plot = ggplot(birdlife300_richness_plot, aes(y=explanatory, x=richness_birdlife_estimate, colour = type)) + 
  ...
  theme(legend.justification = "top")
birdlife300_plot
ggsave('percentage_of_regional_pool__output__birdlife_richness_300_checklists_or_less_result.jpg')
```
...
ggsave('percentage_of_regional_pool__output__birdlife_richness_no_australia.jpg')
```
...
ggsave('percentage_of_regional_pool__output__birdlife_richness_no_africa.jpg')
```
...
birdlifeNAA_plot = ggplot(birdlifeNAA_richness_plot, aes(y=explanatory, x=richness_birdlife_estimate, colour = type)) + 
  ...
  theme(legend.justification = "top")
birdlifeNAA_plot
ggsave('percentage_of_regional_pool__output__birdlife_richness_no_africa_nor_australisia.jpg')
```
...
birdlifeHR_plot = ggplot(birdlifeHR_richness_plot, aes(y=explanatory, x=richness_birdlife_estimate, colour = type)) + 
  ...
  theme(legend.justification = "top")
birdlifeHR_plot
ggsave('percentage_of_regional_pool__output__birdlife_richness_higher_urban.jpg')
```
...
```{r}
plot_sample('0')
ggsave('percentage_of_regional_pool__output__birdlife_locality_sample0.jpg')
```

```{r}
plot_sample('1')
ggsave('percentage_of_regional_pool__output__birdlife_locality_sample1.jpg')
```


```{r}
plot_sample('2')
ggsave('percentage_of_regional_pool__output__birdlife_locality_sample2.jpg')
```

```{r}
plot_sample('3')
ggsave('percentage_of_regional_pool__output__birdlife_locality_sample3.jpg')
```

```{r}
plot_sample('4')
ggsave('percentage_of_regional_pool__output__birdlife_locality_sample4.jpg')
```

```{r}
plot_sample('5')
ggsave('percentage_of_regional_pool__output__birdlife_locality_sample5.jpg')
```

```{r}
plot_sample('6')
ggsave('percentage_of_regional_pool__output__birdlife_locality_sample6.jpg')
```

```{r}
plot_sample('7')
ggsave('percentage_of_regional_pool__output__birdlife_locality_sample7.jpg')
```

```{r}
plot_sample('8')
ggsave('percentage_of_regional_pool__output__birdlife_locality_sample8.jpg')
```

```{r}
plot_sample('9')
ggsave('percentage_of_regional_pool__output__birdlife_locality_sample9.jpg')
```