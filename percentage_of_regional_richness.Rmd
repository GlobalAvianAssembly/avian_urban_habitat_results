...
merlin_richness_plot$type[merlin_richness_plot$explanatory %in% c('mean_elevation_scaled', 'elevation_delta_scaled')] <- 'Scaled (0-1) average elevation\n5 km around site'
...
birdlife_richness_plot$type[birdlife_richness_plot$explanatory %in% c('mean_elevation_scaled', 'elevation_delta_scaled')] <- 'Scaled (0-1) average elevation\n5 km around site'
...
birdlife_plot
ggsave('percentage_of_regional_pool__output__birdlife_richness_result__with_legend.jpg')
```
```{r}
library(gridExtra)
...
jpeg('percentage_of_regional_pool__output__birdlife_richness_result__legend.jpg', width = 200, height = 200)
grid.newpage()
grid.draw(birdlife_legend) 
dev.off()
```
