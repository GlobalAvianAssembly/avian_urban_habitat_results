...
birdlife_family_continuous_trait_evolution$cols[1:colourCount]<-colorRampPalette(c("#c2cc31","#3134cc"), space="Lab")(colourCount)
```
...
plot(birdlife_family_continuous_trait_evolution, type="fan", outline=FALSE, fsize=2, lwd = c(20, 10), cex.legend=0.5, leg.txt="Cities/regional pools")
dev.off()
```
