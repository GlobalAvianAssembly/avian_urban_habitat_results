...
birdlife_jitter_up_up = c('Larks', 'Goldcrests and kinglets', 'Broadbills', 'Butcherbirds', 'Woodhoopoes', 'Toucans and barbets', 'New World vultures', 'Honeyeaters', 'Anhingas', 'Australasian robins', 'Lyrebirds', 'Sparrows, snowfinches and allies', 'Ibises and spoonbills', 'Whipbirds, wedgebills and jewel-babblers', 'Leafbirds', 'Shrikes', 'Falcons and caracaras')

birdlife_jitter_up_up_up = c('Oystercatchers', 'Pelicans', 'Thick-knees')
```
