...
load_niche_data <- function() {
  filename <- 'species_analysis__output__cache.csv'
...
write_csv(all_species_results, "species_analysis__output__result_10_perc.csv")
```
...
write_csv(all_species_results, "species_analysis__output__result_20_perc.csv")
```

------------------------------
Comparing the 2 percentiles - Merlin
------------------------------
...
```
------------------------------
Comparing the 2 percentiles - Birdlife
------------------------------

```{r}
ggplot(birdlife_species_data, aes(x = response, y = trophic_niche, color = percentile)) + geom_boxplot() + theme_bw() +
  xlab("Niche fullness") + ylab("Trophic Niche") + labs(title = "Birdlife") + guides(color=guide_legend(title="Most Urbanised Species")) + theme(legend.position="bottom")

ggsave("species_analysis__output__birdlife_niche_fullness.jpg")
```
...
```
```{r}
mean(birdlife_diff_data$increase[birdlife_diff_data$trophic_niche == 'Invertivore'])
sd(birdlife_diff_data$increase[birdlife_diff_data$trophic_niche == 'Invertivore'])
```

```{r}
mean(birdlife_diff_data$increase[birdlife_diff_data$trophic_niche == 'Aquatic predator'])
sd(birdlife_diff_data$increase[birdlife_diff_data$trophic_niche == 'Aquatic predator'])
```

```{r}
mean(birdlife_diff_data$increase[birdlife_diff_data$trophic_niche == 'Herbivore aquatic'])
sd(birdlife_diff_data$increase[birdlife_diff_data$trophic_niche == 'Herbivore aquatic'])
```

```{r}
mean(birdlife_diff_data$increase[birdlife_diff_data$trophic_niche == 'Vertivore'])
sd(birdlife_diff_data$increase[birdlife_diff_data$trophic_niche == 'Vertivore'])
```

```{r}
mean(birdlife_diff_data$increase[birdlife_diff_data$trophic_niche == 'Scavenger'])
sd(birdlife_diff_data$increase[birdlife_diff_data$trophic_niche == 'Scavenger'])
```

```{r}
mean(birdlife_diff_data$increase[birdlife_diff_data$trophic_niche == 'Omnivore'])
sd(birdlife_diff_data$increase[birdlife_diff_data$trophic_niche == 'Omnivore'])
```

```{r}
mean(birdlife_diff_data$increase[birdlife_diff_data$trophic_niche == 'Nectarivore'])
sd(birdlife_diff_data$increase[birdlife_diff_data$trophic_niche == 'Nectarivore'])
```


```{r}
mean(birdlife_diff_data$increase[birdlife_diff_data$trophic_niche == 'Herbivore terrestrial'])
sd(birdlife_diff_data$increase[birdlife_diff_data$trophic_niche == 'Herbivore terrestrial'])
```

```{r}
mean(birdlife_diff_data$increase[birdlife_diff_data$trophic_niche == 'Granivore'])
sd(birdlife_diff_data$increase[birdlife_diff_data$trophic_niche == 'Granivore'])
```

```{r}
mean(birdlife_diff_data$increase[birdlife_diff_data$trophic_niche == 'Frugivore'])
sd(birdlife_diff_data$increase[birdlife_diff_data$trophic_niche == 'Frugivore'])
```

```{r}
birdlife_fullness_increase <- birdlife_diff_data %>% group_by(trophic_niche) %>% summarise(across(.cols = c("increase"), list(mean = mean, sd = sd)))
birdlife_fullness_increase
```
...
ggsave("species_analysis__output__trophic_niche_accumlation.jpg")
```
```{r}
...
ggplot(accumulation, aes(x = percent, y = birdlife_niche_count)) + 
  ...
  scale_linetype_manual(values=c("blank", "solid"), guide = "none") +
  geom_hline(data = . %>% group_by(trophic_niche) %>% filter(birdlife_niche_count == max(birdlife_niche_count)), aes(yintercept = birdlife_niche_count), color = "blue", size = 0.25, linetype = "dashed") +
  geom_vline(xintercept = 10, colour = "#F8766D") +
  geom_vline(xintercept = 20, colour = "#00BFC4") +
  theme_bw() +
  theme(legend.position = "bottom", strip.text = element_text(size = 6), axis.text.x = element_text(angle = 90, size = 6),  axis.text.y = element_text(size = 6)) +
...
```{r}
birdlife_compare_counts_10 <- accumulation[accumulation$percent == 10, c("trophic_niche", "birdlife_niche_count")]
names(birdlife_compare_counts_10) <- c("trophic_niche", "top_10_count")
birdlife_compare_counts_10
```

```{r}
birdlife_compare_counts_20 <- accumulation[accumulation$percent == 20, c("birdlife_niche_count")]
names(birdlife_compare_counts_20) <- c("top_20_count")
birdlife_compare_counts_100 <- accumulation[accumulation$percent == 100, c("birdlife_niche_count")]
names(birdlife_compare_counts_100) <- c("top_100_count")

birdlife_compare_counts <- cbind(birdlife_compare_counts_10, birdlife_compare_counts_20, birdlife_compare_counts_100)
birdlife_compare_counts$diff <- birdlife_compare_counts$top_20_count - birdlife_compare_counts$top_10_count
birdlife_compare_counts$increase <- birdlife_compare_counts$diff / birdlife_compare_counts$top_10_count

birdlife_compare_counts$top_10_perc <- birdlife_compare_counts$top_10_count / birdlife_compare_counts$top_100_count
birdlife_compare_counts$top_20_perc <- birdlife_compare_counts$top_20_count / birdlife_compare_counts$top_100_count
...
niche_count_data$urban_10_perc <- niche_count_data$top_10_count / niche_count_data$urban_niche_count
niche_count_data$urban_20_perc <- niche_count_data$top_20_count / niche_count_data$urban_niche_count


niche_count_data$total_perc <- niche_count_data$urban_niche_count / niche_count_data$top_100_count

names(birdlife_fullness_increase) <- c("trophic_niche", "fullness_increase_mean", "fullness_increase_sd")
niche_count_data <- right_join(niche_count_data, birdlife_fullness_increase)

format(niche_count_data[,c("trophic_niche", "top_10_count", "top_20_count", "increase", "top_10_perc", "top_20_perc", "urban_10_perc", "urban_20_perc", "top_100_count", "total_perc", "urban_niche_count", "fullness_increase_mean", "fullness_increase_sd")], digits = 2)
```

```{r}
write_csv(format(niche_count_data[,c("trophic_niche", "top_10_count", "top_20_count", "increase", "top_10_perc", "top_20_perc", "urban_10_perc", "urban_20_perc", "top_100_count", "total_perc", "urban_niche_count", "fullness_increase_mean", "fullness_increase_sd")], digits = 2), "species_analysis__output__niche_accumulation_results.csv")
```
