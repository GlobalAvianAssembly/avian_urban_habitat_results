...
myplot <- ggarrange(
  ncol = 2,
  nrow = 2,
  ggplot(merlin_data, aes(x = pc1, y = pc3, alpha = presence_ratio, colour = niche)) + geom_point() + theme_bw() +  theme(legend.position="none", axis.title.x=element_blank()) + ylab("ST + PB -> LT + SB"),
  ggplot(merlin_data, aes(x = pc2, y = pc3, alpha = presence_ratio, colour = niche)) + geom_point() + theme_bw() + theme(legend.position="none", axis.title.x=element_blank(), axis.title.y=element_blank()),
  ggplot(merlin_data, aes(x = pc1, y = pc4, alpha = presence_ratio, colour = niche)) + geom_point() + theme_bw() + theme(legend.position="none") + ylab("LT + PB -> ST + SB") + xlab("Body Size"),
  ggplot(merlin_data, aes(x = pc2, y = pc4, alpha = presence_ratio, colour = niche)) + geom_point() + theme_bw() + theme(legend.position="none", axis.title.y=element_blank()) + xlab("Beak Size")
)
myplot
```
```{r}
